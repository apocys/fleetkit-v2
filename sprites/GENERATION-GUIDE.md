# FleetKit v2 - Sprite Generation Guide
...
2. **Export Format**
   ...
   - Naming: `fleetkit-characters-v1.png`

### Phase 4: PixiJS Integration (1 hour)
1. **Load Sprite Sheet**
```javascript
// Load the sprite sheet
const texture = await PIXI.Assets.load('sprites/fleetkit-characters-v1.png');
...
const spriteData = {
    ...
    meta: { 
        image: 'fleetkit-characters-v1.png',
        format: 'RGBA8888',
        size: { w: 384, h: 240 }
    }
};
...
*Generated by Hunter (CRO) - Market research focused on fastest time-to-market for FleetKit v2 virtual office sprites*